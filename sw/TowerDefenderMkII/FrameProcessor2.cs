...
namespace TowerDefender
{
    public class FrameProcessor
    {
       ...
       // Color _color = Color.FromArgb(50, 120, 200);
...
// set color ranges to keep
        ...
        public Bitmap ProcessFrame(Bitmap frame)
        {
           ...
           // filter.ApplyInPlace(frame);
            // create filter
          //  AForge.Imaging.Filters.SaturationCorrection filter2 = new AForge.Imaging.Filters.SaturationCorrection(0.1f);
            // apply the filter
           // filter2.ApplyInPlace(frame);
            filter.ApplyInPlace(frame);
            ...
            if (rects.Length > 0)
            {
                ...
                GlobalVar.nothingTimerEnabled = false;
